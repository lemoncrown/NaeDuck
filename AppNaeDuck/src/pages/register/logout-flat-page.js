...
var LogoutFlatPage = (function () {
    function LogoutFlatPage(navCtrl, navParams, service, toastCtrl, httpService, viewCtrl) {
        var _this = this;
    ...
    //LIST
    LogoutFlatPage.prototype.getData = function (params) {
        var _this = this;
        var body = {
            TID: "FES-1002",
            Items: [
    ...
    LogoutFlatPage.prototype.dismiss = function () {
        this.viewCtrl.dismiss();
    };
    return LogoutFlatPage;
}());
LogoutFlatPage = __decorate([
    IonicPage(),
    Component({
    ...
    __metadata("design:paramtypes", [NavController, NavParams, LoginService, ToastService,
        HttpService,
        ViewController])
], LogoutFlatPage);
export { LogoutFlatPage };
//# sourceMappingURL=logout-flat-page.js.map